...
/**
 * @extends ServiceEntityRepository<CommentUser>
 *
...
class CommentUserRepository extends ServiceEntityRepository
{
    ...
    public function save(CommentUser $entity, bool $flush = false): void
    {
    ...
    public function remove(CommentUser $entity, bool $flush = false): void
    {
